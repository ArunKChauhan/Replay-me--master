//
//  AGVideoPlayerView.swift
//  Pet-Mates
//
//  Created by MacMini_2 on 04/12/2018.
//  Copyright © 2018 MacMini_2. All rights reserved.
//
...
extension AGVideoPlayerView {
    ...
    private func configurateControls() {
        customControlsContentView = UIView(frame: self.frame)
...
extension AGVideoPlayerView {
    fileprivate func isVisible() -> Bool {
        ...
        let selfFrame = self.convert(self.bounds, to: UIApplication.shared.windows.first)
